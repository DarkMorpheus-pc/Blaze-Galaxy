...
QtObject {
    ...
    readonly property list<var> pages: [
        ...
        {
            label: qsTr("SolarUI Engine"),
            icon: "memory",
            description: qsTr("Switch between Noctalia, Caelestia & Hybrid modes"),
            category: "system"
        },
        {
            label: qsTr("Noctalia Settings"),
            icon: "settings_suggest",
            description: qsTr("Advanced Noctalia Shell Configuration"),
            category: "system"
        },
        {
            label: qsTr("Plugins"),
