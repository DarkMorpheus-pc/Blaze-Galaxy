...
namespace noctalia::config::schema {
  ...
  const Schema<SolarUIConfig>& solaruiSchema() {
    static const Schema<SolarUIConfig> s = {
        field(&SolarUIConfig::shellEngine, "shell_engine"),
        field(&SolarUIConfig::launcherProvider, "launcher_provider"),
        field(&SolarUIConfig::dashboardProvider, "dashboard_provider"),
        field(&SolarUIConfig::performanceProfile, "performance_profile"),
        field(&SolarUIConfig::clockEnabled, "clock_enabled"),
        field(&SolarUIConfig::clockStyle, "clock_style"),
        field(&SolarUIConfig::clockOpacity, "clock_opacity", kUnitRange),
        field(&SolarUIConfig::clockBattery, "clock_battery"),
        field(&SolarUIConfig::clockDate, "clock_date"),
        field(&SolarUIConfig::clockColorMode, "clock_color_mode"),
        field(&SolarUIConfig::taskbarPreset, "taskbar_preset"),
        field(&SolarUIConfig::taskbarOpacity, "taskbar_opacity", kUnitRange),
        field(&SolarUIConfig::taskbarRadius, "taskbar_radius", Range<std::int64_t>{0, 100}),
        field(&SolarUIConfig::taskbarThickness, "taskbar_thickness", Range<std::int64_t>{32, 120}),
        field(&SolarUIConfig::windowMode, "window_mode"),
    };
    return s;
  }
